...
class NetEnemyComp : public BaseNet_Comp
{
public:
	...
	SoundSourceComponent* m_SoundSource;
...
public:
	...
	void ExitState(NetEnemyComp::EnemyStates newState);
};